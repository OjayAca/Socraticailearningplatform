    ...
    children: [
      ...
      // ── System Admin Routes ─────────────────────────────────
      {
        ...
        children: [
          ...
          { path: "admin/progress", lazy: async () => ({ Component: (await import("./components/SecureAdmin")).SecureAdminProgress }) },
          { path: "admin/progress/:userId", lazy: async () => ({ Component: (await import("./components/SecureAdmin")).SecureAdminProgressDetail }) },
          ...
          { path: "admin/reports/print", lazy: async () => ({ Component: (await import("./components/SecureAdmin")).SecureAdminReportPrint }) },
          ...
          { path: "admin/profile", lazy: async () => ({ Component: (await import("./components/SecureAdmin")).SecureAdminProfile }) },
          { path: "admin/submissions", element: <Navigate to="/admin/dashboard" replace /> },
          { path: "admin/notifications", lazy: async () => ({ Component: (await import("./components/SecureAdmin")).SecureAdminNotifications }) },
