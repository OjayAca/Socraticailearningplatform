...
scenario("create own learning session", "ALLOW", "sessions/new", "create", {}, { request: { time, resource: { data: session } }, mocks: [topicMock, questionMock] });
...
scenario("append own response with matching session update", "ALLOW", "sessions/session/responses/answer", "create", {}, { request: { time, resource: { data: response } }, mocks: [getMock("sessions/session", session), getMock("sessions/session", afterSession, "getAfter")] });
...
scenario("update own session", "ALLOW", "sessions/session", "update", session, { request: { time, resource: { data: afterSession } }, mocks: [getMock("sessions/session", session)] });
...
scenario("save own progress", "ALLOW", "learning_progress/rules-alice", "create", {}, { request: { time, resource: { data: progress } } });
...
scenario("write assignment state", "ALLOW", "learning_progress/rules-alice/assignment_state/topic", "create", {}, { request: { time, resource: { data: { activeSessionId: "session", answeredProblemIds: [], updatedAt: time } } }, mocks: [getMock("sessions/session", session, "getAfter")] });
